        ...
        <footer>
            <div id="FooterTopRow">
                ...
                <div id="FooterContact">
                    <div className="FooterContactLine">contact@yourdomain.com</div>
                    <div className="FooterContactLine">+1 234 567 890</div>
                    <div className="FooterContactLine">123 Startup Lane, Innovation City, USA</div>
                </div>
               
                <div id="NavbarFiller">-</div>
                <div id="FooterInfo">
                    <div id="FooterInfoHead">AI-powered insights for unstoppable solo founders.</div>
                    <div className="FooterContactLine">Turn your ideas into reality with AI-powered guidance. From validation to scaling, we help you navigate the startup journey with confidence.</div>
                </div>
            </div>
